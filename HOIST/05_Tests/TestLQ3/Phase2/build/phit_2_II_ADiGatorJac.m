...
xp.dI = I.dI(5);
% Deriv 1 Line: xp.dI = I.dI(5);
xp.f = I.f(5,1);
% Deriv 1 Line: xp.f = I.f(5,1);
%User Line: xp = I(5: 5, 1);
wp.dI = I.dI(6);
% Deriv 1 Line: wp.dI = I.dI(6);
wp.f = I.f(6,1);
% Deriv 1 Line: wp.f = I.f(6,1);
...
target.f = [-5;2];
% Deriv 1 Line: target.f =  [-5; 2];
%User Line: target = [-5; 2];
Psi.dI = xm.dI;
% Deriv 1 Line: Psi.dI = xm.dI;
Psi.f = xm.f - target.f;
% Deriv 1 Line: Psi.f = xm.f - target.f;
...
cada1f1dI = wm.dI;
% Deriv 1 Line: cada1f1dI = wm.dI;
cada1f1 = wm.f.';
% Deriv 1 Line: cada1f1 = wm.f.';
cada1td2 =  zeros(2,2);
% Deriv 1 Line: cada1td2 = zeros(2,2);
cada1td2(Gator1Data.Index1) = cada1f1dI;
% Deriv 1 Line: cada1td2(Gator1Data.Index1) = cada1f1dI;
cada2f1dI = wm.dI;
cada2f1 = wm.f.';
cada2td1 = zeros(2,2);
cada2td1(Gator2Data.Index1) = cada2f1dI;
...
cada1td2dI = cada2td1(Gator2Data.Index2);
cada1td2 = cada2f1*cada1td2;
% Deriv 1 Line: cada1td2 = wm.f.'*cada1td2;
cada1td1dI = cada1td2dI(Gator2Data.Index3);
cada1td1 = cada1td2(Gator1Data.Index2);
% Deriv 1 Line: cada1td1 = cada1td2(Gator1Data.Index2);
cada1td1 = cada1td1(:);
% Deriv 1 Line: cada1td1 = cada1td1(:);
cada1td2 =  zeros(2,2);
% Deriv 1 Line: cada1td2 = zeros(2,2);
cada1td2(Gator1Data.Index3) = wm.dI;
% Deriv 1 Line: cada1td2(Gator1Data.Index3) = wm.dI;
cada2td1 = zeros(2,2);
cada2td1(Gator2Data.Index4) = cada1f1dI;
cada2td1 = cada1td2.'*cada2td1;
cada2td1 = cada2td1(:);
...
cada1td2 = cada1td2(:);
% Deriv 1 Line: cada1td2 = cada1td2(:);
cada2f1dI = cada1td2dI(Gator2Data.Index6);
cada2f1 = cada1td2(Gator1Data.Index4);
cada2td1 = cada1td1dI;
cada2td1 = cada2td1 + cada2f1dI;
cada1td1dI = cada2td1;
cada1td1 = cada1td1 + cada2f1;
% Deriv 1 Line: cada1td1 = cada1td1 + cada1td2(Gator1Data.Index4);
phi.dIdI = cada1td1dI; phi.dI = cada1td1;
% Deriv 1 Line: phi.dI = cada1td1;
phi.f = cada1f1*wm.f;
% Deriv 1 Line: phi.f = cada1f1*wm.f;
%User Line: phi = wm' * wm;
end
