...
cada1f1dI = wm.dI(1);
cada1f1 = wm.f(1);
cada1f2dI = 2.*cada1f1.^(2-1).*cada1f1dI;
cada1f2 = cada1f1^2;
cada1f3dI = wm.dI(2);
cada1f3 = wm.f(2);
cada1f4dI = 2.*cada1f3.^(2-1).*cada1f3dI;
cada1f4 = cada1f3^2;
cada1td1 = zeros(2,1);
cada1td1(1) = cada1f2dI;
cada1td1(2) = cada1td1(2) + cada1f4dI;
cada1f5dI = cada1td1;
cada1f5 = cada1f2 + cada1f4;
cada1f6dI = wm.dI(3);
cada1f6 = wm.f(3);
cada1f7dI = 2.*cada1f6.^(2-1).*cada1f6dI;
cada1f7 = cada1f6^2;
cada1td1 = zeros(3,1);
cada1td1(Gator1Data.Index1) = cada1f5dI;
cada1td1(3) = cada1td1(3) + cada1f7dI;
phi.dI = cada1td1;
