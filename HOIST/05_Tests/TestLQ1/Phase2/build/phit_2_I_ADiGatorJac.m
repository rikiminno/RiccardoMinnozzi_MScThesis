...
cada1f4 = Psi.f.';
cada1td2 = zeros(3,3);
cada1td2(Gator1Data.Index13) = cada1f4dI;
cada1td2 = Psi.f.'*cada1td2;
cada1td1 = cada1td2(Gator1Data.Index14);
cada1td1 = cada1td1(:);
cada1td2 = zeros(3,3);
cada1td2(Gator1Data.Index15) = Psi.dI;
cada1td2 = cada1f4*cada1td2;
cada1td2 = cada1td2(:);
cada1td1 = cada1td1 + cada1td2(Gator1Data.Index16);
cada1f5dI = cada1td1;
cada1f5 = cada1f4*Psi.f;
cada1f6dI = sigma.*cada1f5dI;
cada1f6 = sigma*cada1f5;
cada1td1 = cada1f3dI;
cada1td1(Gator1Data.Index17) = cada1td1(Gator1Data.Index17) + cada1f6dI;
phit.dI = cada1td1;
phit.f = cada1f3 + cada1f6;
%User Line: phit = phi + lm' * Psi + sigma * (Psi' * Psi);
phit.dI_size = 17;
phit.dI_location = Gator1Data.Index18;
end
