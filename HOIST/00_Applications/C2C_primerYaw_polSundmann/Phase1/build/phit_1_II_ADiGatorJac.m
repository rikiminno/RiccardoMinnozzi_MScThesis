...
gator_I.dI.f = [1;1;1;1;1;1;1;1;1];
%User Line: gator_I.dI = ones(9,1);
...
% Deriv 1 Line: lm.dI = I.dI(Gator1Data.Index4);
lm.f = I.f(Gator1Data.Index3,1);
% Deriv 1 Line: lm.f = I.f(Gator1Data.Index3,1);
...
Psi.dIdI = cadaoutput2_1.dIdI; Psi.dI = cadaoutput2_1.dI;
...
cada1td2 =  zeros(2,2);
% Deriv 1 Line: cada1td2 = zeros(2,2);
cada1td2(Gator1Data.Index5) = cada1f1dI;
% Deriv 1 Line: cada1td2(Gator1Data.Index5) = cada1f1dI;
cada2f1dI = Psi.dI;
cada2f1 = Psi.f.';
cada2td1 = zeros(2,3);
...
cada2f1 = cada1td2(Gator1Data.Index6);
cada1td1dI = cada2f1dI;
cada1td1(Gator1Data.Index7) = cada2f1;
% Deriv 1 Line: cada1td1(Gator1Data.Index7) = cada1td2(Gator1Data.Index6);
cada1td2 =  zeros(2,3);
% Deriv 1 Line: cada1td2 = zeros(2,3);
cada1td2dI = Psi.dIdI;
cada1td2(Gator1Data.Index8) = Psi.dI;
% Deriv 1 Line: cada1td2(Gator1Data.Index8) = Psi.dI;
cada2td2 = zeros(2,2);
cada2td2(Gator2Data.Index4) = cada1f1dI;
cada2td2 = cada1td2.'*cada2td2;
cada2td1 = zeros(4,1);
cada2td1(Gator2Data.Index6) = cada2td2(Gator2Data.Index5);
cada2td2 = zeros(2,1);
cada2td2(2) = cada1td2dI;
...
cada2f2dI = cada1td2dI(Gator2Data.Index7);
cada2f2 = cada1td2(Gator1Data.Index9);
cada2f3dI = cada2f2dI;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(7,1);
cada2td1(Gator2Data.Index8) = cada2f3dI;
cada2td1(Gator2Data.Index9) = cada1td1dI(Gator2Data.Index10);
cada1td1dI = cada2td1;
cada1td1(Gator1Data.Index10) = cada2f3;
% Deriv 1 Line: cada1td1(Gator1Data.Index10) = cada1td1(Gator1Data.Index10) + cada1td2(Gator1Data.Index9);
...
% Deriv 1 Line: cada1td1 = zeros(5,1);
cada1td1(1) = phi.dI;
% Deriv 1 Line: cada1td1(1) = phi.dI;
cada1td1dI = cada1f2dIdI;
cada1td1 = cada1td1 + cada1f2dI;
% Deriv 1 Line: cada1td1 = cada1td1 + cada1f2dI;
...
cada1f4dIdI = Psi.dIdI; cada1f4dI = Psi.dI;
% Deriv 1 Line: cada1f4dI = Psi.dI;
cada1f4 = Psi.f.';
% Deriv 1 Line: cada1f4 = Psi.f.';
cada1td2 =  zeros(2,3);
% Deriv 1 Line: cada1td2 = zeros(2,3);
cada1td2dI = cada1f4dIdI;
cada1td2(Gator1Data.Index11) = cada1f4dI;
% Deriv 1 Line: cada1td2(Gator1Data.Index11) = cada1f4dI;
cada2f1dI = Psi.dI;
cada2f1 = Psi.f.';
cada2td2 = zeros(2,3);
cada2td2(Gator2Data.Index11) = cada2f1dI;
cada2td2 = cada1td2.'*cada2td2;
cada2td1 = cada2td2(Gator2Data.Index12);
cada2td1 = cada2td1(:);
cada2td2 = zeros(2,1);
cada2td2(2) = cada1td2dI;
...
cada1td2 = cada2f1*cada1td2;
% Deriv 1 Line: cada1td2 = Psi.f.'*cada1td2;
cada1td1dI = cada1td2dI(Gator2Data.Index13);
cada1td1 = cada1td2(Gator1Data.Index12);
% Deriv 1 Line: cada1td1 = cada1td2(Gator1Data.Index12);
cada1td1 = cada1td1(:);
...
% Deriv 1 Line: cada1td2(Gator1Data.Index13) = Psi.dI;
cada2td2 = zeros(2,3);
cada2td2(Gator2Data.Index14) = cada1f4dI;
cada2td2 = cada1td2.'*cada2td2;
cada2td1 = cada2td2(Gator2Data.Index15);
cada2td1 = cada2td1(:);
cada2td2 = zeros(2,1);
cada2td2(2) = cada1td2dI;
...
cada1td2 = cada1td2(:);
% Deriv 1 Line: cada1td2 = cada1td2(:);
cada2f1dI = cada1td2dI(Gator2Data.Index16);
cada2f1 = cada1td2(Gator1Data.Index14);
cada2td1 = cada1td1dI;
cada2td1 = cada2td1 + cada2f1dI;
cada1td1dI = cada2td1;
cada1td1 = cada1td1 + cada2f1;
% Deriv 1 Line: cada1td1 = cada1td1 + cada1td2(Gator1Data.Index14);
...
cada2f1dI = cada1td1dI(Gator2Data.Index17);
cada2f1 = cada1td1(Gator1Data.Index15);
cada2td1 = zeros(8,1);
cada2td1(Gator2Data.Index18) = cada2f1dI;
cada2td1(Gator2Data.Index19) = cada2td1(Gator2Data.Index19) + cada1f6dIdI;
cada2f2dI = cada2td1;
cada2f2 = cada2f1 + cada1f6dI;
cada2td1 = zeros(11,1);
cada2td1(Gator2Data.Index20) = cada2f2dI;
cada2td1(Gator2Data.Index21) = cada1td1dI(Gator2Data.Index22);
cada1td1dI = cada2td1;
cada1td1(Gator1Data.Index15) = cada2f2;
% Deriv 1 Line: cada1td1(Gator1Data.Index15) = cada1td1(Gator1Data.Index15) + cada1f6dI;
...
phit.dI_size = 9;
% Deriv 1 Line: phit.dI_size = 9;
phit.dI_location = Gator1Data.Index16;
% Deriv 1 Line: phit.dI_location = Gator1Data.Index16;
end
...
%User Line: global
Psi.f = [0;0];
% Deriv 1 Line: Psi.f =  zeros(2, 1);
%User Line: Psi = zeros(2, 1);
cada1f1dI = xm.dI(3);
% Deriv 1 Line: cada1f1dI = xm.dI(3);
cada1f1 = xm.f(3);
% Deriv 1 Line: cada1f1 = xm.f(3);
Psi.dI = cada1f1dI;
% Deriv 1 Line: Psi.dI = cada1f1dI;
Psi.f(1,1) = cada1f1;
% Deriv 1 Line: Psi.f(1,1) = cada1f1;
%User Line: Psi(1, 1) = xm(3);
cada1f1dI = xm.dI(4);
% Deriv 1 Line: cada1f1dI = xm.dI(4);
cada1f1 = xm.f(4);
% Deriv 1 Line: cada1f1 = xm.f(4);
cada1f2dI = xm.dI(1);
% Deriv 1 Line: cada1f2dI = xm.dI(1);
cada1f2 = xm.f(1);
% Deriv 1 Line: cada1f2 = xm.f(1);
cada2f1dI = (1/2)./sqrt(cada1f2).*cada1f2dI;
cada2f1dI(cada1f2 == 0 & cada1f2dI == 0) = 0;
cada2f1 = sqrt(cada1f2);
cada2f2dI = -0.5./cada2f1.^2.*cada2f1dI;
cada2f2 = 0.5/cada2f1;
cada1f3dIdI = cada1f2dI.*cada2f2dI;
cada1f3dI = cada2f2*cada1f2dI;
% Deriv 1 Line: cada1f3dI = (1/2)./sqrt(cada1f2).*cada1f2dI;
cada2f1 = eq(cada1f2,0);
cada2f2 = eq(cada1f2dI,0);
cada2f3 = and(cada2f1,cada2f2);
cada1f3dI(cada2f3) = 0;
% Deriv 1 Line: cada1f3dI(cada1f2 == 0 & cada1f2dI == 0) = 0;
cada1f3 = sqrt(cada1f2);
% Deriv 1 Line: cada1f3 = sqrt(cada1f2);
cada2f1dI = 2.*cada1f3.^(2-1).*cada1f3dI;
cada2f1 = cada1f3^2;
cada2f2dI = -(-1)./cada2f1.^2.*cada2f1dI;
cada2f2 = (-1)/cada2f1;
cada2td1 = cada1f3dI.*cada2f2dI;
cada2td1 = cada2td1 + cada2f2.*cada1f3dIdI;
cada1f4dIdI = cada2td1;
cada1f4dI = cada2f2*cada1f3dI;
% Deriv 1 Line: cada1f4dI = -1./cada1f3.^2.*cada1f3dI;
cada1f4 = 1/cada1f3;
...
cada2f2 = uminus(cada1f4dI);
cada2f3dI = cada2f2dI;
cada2f3 = cada2f1 + cada2f2;
cada1td1dI = cada2f3dI;
cada1td1(1) = cada2f3;
% Deriv 1 Line: cada1td1(1) = cada1td1(1) + -cada1f4dI;
cada1f5dIdI = cada1td1dI; cada1f5dI = cada1td1;
% Deriv 1 Line: cada1f5dI = cada1td1;
cada1f5 = cada1f1 - cada1f4;
% Deriv 1 Line: cada1f5 = cada1f1 - cada1f4;
cada1td1 =  zeros(3,1);
...
cada2f1 = Psi.dI(1);
cada1td1(2) = cada2f1;
% Deriv 1 Line: cada1td1(2) = Psi.dI(1);
Psi.dIdI = cada1td1dI; Psi.dI = cada1td1;
% Deriv 1 Line: Psi.dI = cada1td1;
Psi.f(2,1) = cada1f5;
% Deriv 1 Line: Psi.f(2,1) = cada1f5;
...
cada1f1dI = xm.dI(1);
% Deriv 1 Line: cada1f1dI = xm.dI(1);
cada1f1 = xm.f(1);
% Deriv 1 Line: cada1f1 = xm.f(1);
phi.dI = uminus(cada1f1dI);
% Deriv 1 Line: phi.dI = -cada1f1dI;
phi.f = uminus(cada1f1);
% Deriv 1 Line: phi.f = uminus(cada1f1);
%User Line: phi = - xm(1);
end
