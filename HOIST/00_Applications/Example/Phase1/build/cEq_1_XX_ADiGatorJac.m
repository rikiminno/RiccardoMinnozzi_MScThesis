...
function cEq_X = cEq_1_XX_ADiGatorJac(t,X)
global ADiGator_cEq_1_XX_ADiGatorJac
if isempty(ADiGator_cEq_1_XX_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_cEq_1_XX_ADiGatorJac.cEq_1_XX_ADiGatorJac.Gator1Data;
...
cadaoutput2_1 = cEq_1_X_ADiGatorJac(cadainput2_1,cadainput2_2);
% Call to function: cEq_1_X_ADiGatorJac
cEq = cadaoutput2_1;
%User Line: cEq = cadaoutput2_1;
cEq.dX.f = Gator1Data.Data2;
%User Line: cEq.dX = zeros(10,1);
cEq_X.f =  zeros(1,10);
%User Line: cEq_X = zeros(1,10);
end
function cEq = cEq_1_X_ADiGatorJac(t,X)
global ADiGator_cEq_1_XX_ADiGatorJac
Gator1Data = ADiGator_cEq_1_XX_ADiGatorJac.cEq_1_X_ADiGatorJac.Gator1Data;
Gator2Data = ADiGator_cEq_1_XX_ADiGatorJac.cEq_1_X_ADiGatorJac.Gator2Data;
% ADiGator Start Derivative Computations
...
cadaoutput3_1 = ADiGator_path_eq_constraints_11(cadainput3_1,cadainput3_2,cadainput3_3,cadainput3_4);
% Call to function: ADiGator_path_eq_constraints_11
...
global ADiGator_cEq_1_XX_ADiGatorJac
Gator1Data = ADiGator_cEq_1_XX_ADiGatorJac.ADiGator_path_eq_constraints_11.Gator1Data;
Gator2Data = ADiGator_cEq_1_XX_ADiGatorJac.ADiGator_path_eq_constraints_11.Gator2Data;
% ADiGator Start Derivative Computations
...
global ADiGator_cEq_1_XX_ADiGatorJac
ADiGator_cEq_1_XX_ADiGatorJac = load('cEq_1_XX_ADiGatorJac.mat');
return
end