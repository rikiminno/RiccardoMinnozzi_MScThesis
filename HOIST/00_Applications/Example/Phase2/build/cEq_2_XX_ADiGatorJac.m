...
function cEq_X = cEq_2_XX_ADiGatorJac(t,X)
global ADiGator_cEq_2_XX_ADiGatorJac
if isempty(ADiGator_cEq_2_XX_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_cEq_2_XX_ADiGatorJac.cEq_2_XX_ADiGatorJac.Gator1Data;
...
cadaoutput2_1 = cEq_2_X_ADiGatorJac(cadainput2_1,cadainput2_2);
% Call to function: cEq_2_X_ADiGatorJac
cEq = cadaoutput2_1;
%User Line: cEq = cadaoutput2_1;
cEq.dX.f = Gator1Data.Data2;
%User Line: cEq.dX = zeros(15,1);
cEq_X.f =  zeros(1,15);
%User Line: cEq_X = zeros(1,15);
end
function cEq = cEq_2_X_ADiGatorJac(t,X)
global ADiGator_cEq_2_XX_ADiGatorJac
Gator1Data = ADiGator_cEq_2_XX_ADiGatorJac.cEq_2_X_ADiGatorJac.Gator1Data;
Gator2Data = ADiGator_cEq_2_XX_ADiGatorJac.cEq_2_X_ADiGatorJac.Gator2Data;
% ADiGator Start Derivative Computations
%User Line: % Augmented equality path constraints wrapper function for phase 2,
...
cadaoutput3_1 = ADiGator_path_eq_constraints_21(cadainput3_1,cadainput3_2,cadainput3_3,cadainput3_4);
% Call to function: ADiGator_path_eq_constraints_21
cadaoutput2_1 = cadaoutput3_1;
% Deriv 1 Line: cadaoutput2_1 = cadaoutput3_1;
% Call to function: path_eq_constraints_2
cEq.f = cadaoutput2_1.f;
% Deriv 1 Line: cEq.f = cadaoutput2_1.f;
%User Line: cEq = cadaoutput2_1;
end
function cEq = ADiGator_path_eq_constraints_21(t,x,u,w)
global ADiGator_cEq_2_XX_ADiGatorJac
Gator1Data = ADiGator_cEq_2_XX_ADiGatorJac.ADiGator_path_eq_constraints_21.Gator1Data;
Gator2Data = ADiGator_cEq_2_XX_ADiGatorJac.ADiGator_path_eq_constraints_21.Gator2Data;
% ADiGator Start Derivative Computations
...
global ADiGator_cEq_2_XX_ADiGatorJac
ADiGator_cEq_2_XX_ADiGatorJac = load('cEq_2_XX_ADiGatorJac.mat');
return
end