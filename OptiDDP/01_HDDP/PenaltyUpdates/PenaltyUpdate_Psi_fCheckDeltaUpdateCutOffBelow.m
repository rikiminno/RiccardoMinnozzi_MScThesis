classdef PenaltyUpdate_Psi_fCheckDeltaUpdateCutOffBelow < PenaltyUpdate_Psi_fCheckDeltaUpdate
    ...
    % below the feasibility threshold, with update to the trust region
    % radius according to the accuracy of the constraint propagation model)
    %
    % authored by Riccardo Minnozzi, 09/2024

    methods
        function obj = PenaltyUpdate_Psi_fCheckDeltaUpdateCutOffBelow(settings, eps_feas, ID)
