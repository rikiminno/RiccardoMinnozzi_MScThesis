...
function cInEq_X = cInEq_0_XX_ADiGatorJac(t,X)
global ADiGator_cInEq_0_XX_ADiGatorJac
if isempty(ADiGator_cInEq_0_XX_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_cInEq_0_XX_ADiGatorJac.cInEq_0_XX_ADiGatorJac.Gator1Data;
...
cadaoutput2_1 = cInEq_0_X_ADiGatorJac(cadainput2_1,cadainput2_2);
% Call to function: cInEq_0_X_ADiGatorJac
cInEq = cadaoutput2_1;
%User Line: cInEq = cadaoutput2_1;
cInEq.dX.f = [0;0;0];
%User Line: cInEq.dX = zeros(3,1);
cInEq_X.f =  zeros(1,3);
%User Line: cInEq_X = zeros(1,3);
end
function cInEq = cInEq_0_X_ADiGatorJac(t,X)
global ADiGator_cInEq_0_XX_ADiGatorJac
Gator1Data = ADiGator_cInEq_0_XX_ADiGatorJac.cInEq_0_X_ADiGatorJac.Gator1Data;
Gator2Data = ADiGator_cInEq_0_XX_ADiGatorJac.cInEq_0_X_ADiGatorJac.Gator2Data;
% ADiGator Start Derivative Computations
%User Line: % Augmented inequality path constraints wrapper function for phase 0,
...
cadaoutput3_1 = ADiGator_path_ineq_constraints_01(cadainput3_1,cadainput3_2,cadainput3_3,cadainput3_4);
% Call to function: ADiGator_path_ineq_constraints_01
cadaoutput2_1 = cadaoutput3_1;
% Deriv 1 Line: cadaoutput2_1 = cadaoutput3_1;
% Call to function: path_ineq_constraints_0
cInEq.f = cadaoutput2_1.f;
% Deriv 1 Line: cInEq.f = cadaoutput2_1.f;
%User Line: cInEq = cadaoutput2_1;
end
function cInEq = ADiGator_path_ineq_constraints_01(t,x,u,w)
global ADiGator_cInEq_0_XX_ADiGatorJac
Gator1Data = ADiGator_cInEq_0_XX_ADiGatorJac.ADiGator_path_ineq_constraints_01.Gator1Data;
Gator2Data = ADiGator_cInEq_0_XX_ADiGatorJac.ADiGator_path_ineq_constraints_01.Gator2Data;
% ADiGator Start Derivative Computations
...
global ADiGator_cInEq_0_XX_ADiGatorJac
ADiGator_cInEq_0_XX_ADiGatorJac = load('cInEq_0_XX_ADiGatorJac.mat');
return
end