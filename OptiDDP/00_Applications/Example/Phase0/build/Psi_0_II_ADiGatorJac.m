...
Psi.dI.f = Gator1Data.Data2;
%User Line: Psi.dI = zeros(10,1);
Psi_I.f =  zeros(1,10);
%User Line: Psi_I = zeros(1,10);
end
...
%User Line: % automatically generated by the PhaseManager_Psi class on 03-Oct-2024 12:46:48
xm.dI = I.dI(1);
