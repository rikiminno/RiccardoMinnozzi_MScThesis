...
%User Line: Psi_I((Psi.dI_location(:,2)-1)*2+Psi.dI_location(:,1)) = Psi.dI;
Psi_I.dI_size = [2,9,9];
Psi_I.dI_location = Gator1Data.Index1;
end
...
%User Line: Psi = cadaoutput2_1;
Psi.dI_size = [2 9];
% Deriv 1 Line: Psi.dI_size = [2,9];
Psi.dI_location = Gator1Data.Index5;
% Deriv 1 Line: Psi.dI_location = Gator1Data.Index5;
end
