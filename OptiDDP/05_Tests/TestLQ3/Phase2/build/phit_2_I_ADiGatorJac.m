...
global ADiGator_phit_2_I_ADiGatorJac
if isempty(ADiGator_phit_2_I_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_phit_2_I_ADiGatorJac.phit_2_I_ADiGatorJac.Gator1Data;
...
cadaoutput3_1 = ADiGator_terminal_cost_21(cadainput3_1,cadainput3_2,cadainput3_3,cadainput3_4);
...
cada1td2 = cada1td2(:);
cada1td1(Gator1Data.Index12) = cada1td1(Gator1Data.Index12) + cada1td2(Gator1Data.Index11);
cada1f2dI = cada1td1;
cada1f2 = cada1f1*Psi.f;
cada1td1 = zeros(6,1);
cada1td1(Gator1Data.Index13) = phi.dI;
cada1td1(Gator1Data.Index14) = cada1td1(Gator1Data.Index14) + cada1f2dI;
cada1f3dI = cada1td1;
...
global ADiGator_phit_2_I_ADiGatorJac
Gator1Data = ADiGator_phit_2_I_ADiGatorJac.ADiGator_terminal_constraint_21.Gator1Data;
% ADiGator Start Derivative Computations
%User Line: % function that implements the terminal constraints for the current phase
target.f =  [-5; 2];
%User Line: target = [-5; 2];
Psi.dI = xm.dI;
Psi.f = xm.f - target.f;
%User Line: Psi = xm - target;
end
function phi = ADiGator_terminal_cost_21(xm,wm,xp,wp)
global ADiGator_phit_2_I_ADiGatorJac
Gator1Data = ADiGator_phit_2_I_ADiGatorJac.ADiGator_terminal_cost_21.Gator1Data;
% ADiGator Start Derivative Computations
%User Line: % terminal cost for the linear quadratic test problem
cada1f1dI = wm.dI;
cada1f1 = wm.f.';
cada1td2 = zeros(2,2);
cada1td2(Gator1Data.Index1) = cada1f1dI;
cada1td2 = wm.f.'*cada1td2;
cada1td1 = cada1td2(Gator1Data.Index2);
cada1td1 = cada1td1(:);
cada1td2 = zeros(2,2);
cada1td2(Gator1Data.Index3) = wm.dI;
cada1td2 = cada1f1*cada1td2;
cada1td2 = cada1td2(:);
...
global ADiGator_phit_2_I_ADiGatorJac
ADiGator_phit_2_I_ADiGatorJac = load('phit_2_I_ADiGatorJac.mat');
return
end