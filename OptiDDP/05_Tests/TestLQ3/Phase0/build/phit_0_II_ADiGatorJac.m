...
%User Line: gator_I.dI = ones(10,1);
...
phit.dI.f = Gator1Data.Data2;
%User Line: phit.dI = zeros(10,1);
phit_I.f =  zeros(1,10);
%User Line: phit_I = zeros(1,10);
end
...
wp.dI = I.dI(9);
% Deriv 1 Line: wp.dI = I.dI(9);
wp.f = I.f(9,1);
% Deriv 1 Line: wp.f = I.f(9,1);
%User Line: wp = I(9: 9, 1);
lm.dI = I.dI(10);
% Deriv 1 Line: lm.dI = I.dI(10);
lm.f = I.f(10,1);
% Deriv 1 Line: lm.f = I.f(10,1);
