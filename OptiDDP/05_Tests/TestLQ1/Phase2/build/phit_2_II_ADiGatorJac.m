...
% Deriv 1 Line: cada1td2(Gator1Data.Index13) = cada1f4dI;
cada2f1dI = Psi.dI;
cada2f1 = Psi.f.';
cada2td1 = zeros(3,3);
...
% Deriv 1 Line: cada1td1 = cada1td2(Gator1Data.Index14);
cada1td1 = cada1td1(:);
% Deriv 1 Line: cada1td1 = cada1td1(:);
cada1td2 =  zeros(3,3);
% Deriv 1 Line: cada1td2 = zeros(3,3);
cada1td2(Gator1Data.Index15) = Psi.dI;
% Deriv 1 Line: cada1td2(Gator1Data.Index15) = Psi.dI;
cada2td1 = zeros(3,3);
...
% Deriv 1 Line: cada1td1 = cada1td1 + cada1td2(Gator1Data.Index16);
...
% Deriv 1 Line: cada1td1(Gator1Data.Index17) = cada1td1(Gator1Data.Index17) + cada1f6dI;
...
% Deriv 1 Line: phit.dI_location = Gator1Data.Index18;
end
